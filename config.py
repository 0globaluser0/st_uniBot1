...
LISS_BLACKLIST_KEYWORDS = ["knife","charm","tag","gloves"]
...
LISS_SUM_LIMIT = 70.0  # максимальная сумма покупок одного предмета за период
