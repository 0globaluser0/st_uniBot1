...
LISSKINS_API_URL = "https://lis-skins.com/api/v2"

# WebSocket endpoint для мониторинга новых лотов. При отсутствии поддержки оставьте None.
LISSKINS_WS_URL = "wss://lis-skins.com/api/v2/ws"
